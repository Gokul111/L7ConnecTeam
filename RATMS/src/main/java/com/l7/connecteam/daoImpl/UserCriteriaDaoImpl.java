...
public class UserCriteriaDaoImpl implements UserCriteriaDao{
	...
	public UserCriteriaDto createUserCriteriaRel(String empID, Map<String, Integer> criteriaMap, String assess)
		...
		for (String key : criteriaMap.keySet()) {
			...
			try {
				...
				final String sqlAssess = new QueryManager().getQuery("getAssessByName");
				...
				final String sqlTrain = new QueryManager().getQuery("setTrainGrpTechRelByAssessID");
				...
				final String sqlCriteria = new QueryManager().getQuery("getCriteriaByGrpTechID");
				...
				final String sqlUser = new QueryManager().getQuery("getUserByEmpID");
				...
				if (userCriteria.getCriteriaID() == 0) {
					final String sqlEval = new QueryManager().getQuery("setUserEvaluationCriteria");
	...
	public UserCriteriaDto ifUserCriteriaRelExists(int userID, int criteriaID) throws UIException, SQLException {
		...
		try {
			con = connectionManager.getConnection();
			final String sql = new QueryManager().getQuery("ifUserCriteriaRelExists");
